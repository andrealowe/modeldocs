...
class DocumentBuilder:
    ...
    # Brand color used throughout the document
    _BRAND_COLOR = RGBColor(0x1F, 0x4E, 0x79)   # dark navy blue
    ...
    def _add_title_page(self, doc: Document, spec: DocumentSpec) -> None:
        ...
        author_run.font.color.rgb = self._BRAND_COLOR
        ...
        date_run.font.color.rgb = self._MUTED_COLOR
    ...
    def _add_table(
        ...
        for i, col in enumerate(columns):
            ...
            self._shade_cell(header_cells[i], "1F4E79")
